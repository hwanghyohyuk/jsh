	...
	<div class="content-box-large">
		...
		<div class="submenubtn"
			...
			<button class="btn btn-primary"
				style="background-color: white; color: black; pointer-events: none;">지하철승하차인원</button>
			<button class="btn btn-primary"
				onclick="javascript:location.href='dataMgmt_HJD'">생활인구(행정동)</button>
			<button class="btn btn-primary"
				onclick="javascript:location.href='dataMgmt_JGG'">생활인구(집계구)</button>
		</div>
			...
			<div class="logList">
				<c:forEach var="log" items="${ScheduledLog}" varStatus="status">
					<div class="loginfo errorCk${status.index}">
						<div class="logMsg">등록일자 : ${log.workDt}</div>
