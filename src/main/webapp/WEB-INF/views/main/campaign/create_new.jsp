...
<body>
	...
	<div id="container">
		<div id="map-area">
			...
			<div id="mapLogo" style="display:none;position:relative;left:1348px;bottom:43px;"><img src="/resources/images/intro-logo.png" alt="logo-image"></div>
			...
			<div class="create-window-part absolute-lt" id="info-part">
				<div class="info">
					<div class="info-header">
						...
						<input type="text" class="changeable input-none color-000 tfont w-100 show" id="campaignName" value="" placeholder="캠페인 제목을 입력해주세요.">
						</b>
					...
					<div class="info-body">
						<div>
							...
							<span class="w-70">
							<input type="text" class="changeable input-none color-505050 dfont w-70 show" id="advertiser"  value="" placeholder="광고주를 입력해주세요.">
							</span>
						</div>
						<div>
							<b class="info-title">일정</b>
							<input type="text" name="campaignTerm" placeholder="0000.00.00~0000.00.00" class="input-none color-505050 dfont w-70" id="campaignTerm" readonly="readonly" value="" />
						</div>
					</div>
				</div>
			</div>
...
<!-- 											<span class="unicon unicon-red"></span> 가로변 버스쉘터 <span -->
						...
						<div class="option-list">
							...
							<div class="option-item">
								...
								<div class="option-body" style="display: none;">
									...
									<div class="custom-control custom-radio py-2 px-0">
									...
									<div class="custom-control custom-checkbox py-2 px-0" style="display: none;">
			...
			<form name="imgForm" id="imgForm" action="/campaign/CampaignPdfUpload?${_csrf.parameterName}=${_csrf.token}" method="post" enctype="multipart/form-data">
				...
				<div class="d-flex absolute-lb2" id="decide-part">
					<input type="button" id="save" class="btn btn-save btn-no-radius flex-fill" value="저장하기" disabled="disabled"/> <!-- disabled="disabled" -->
					<input type="button" id="reservation" class="btn btn-primary btn-no-radius flex-fill" value="예약하기" disabled="disabled"/>
				</div>
			</c:if>
		</div>
		<div class="create-sub-window shadow">
			<div class="create-window-part absolute-lt" id="sub-part">
				<div class="sub-info pt-3 px-4">
					<div class="info-header overflow-visible mb-2">
						...
						<input type="button" id="contentsSave" class="btn btn-sm btn-radius-all btn-blue float-right"
						value="저장하기" />
						<input type="button" id="selectFile" class="btn btn-sm btn-radius-all btn-black float-right"
						value="파일로 선택" />
					</div>
					<div class="info-body row mx-0 py-3 totalAdInfo">
						<div class="col-7 px-0">
							<b class="info-title w-40 mr-3 mb-1">미디어</b><span class="subTitle"></span><br>
							<b class="info-title w-40 mr-3 mb-1">개수</b><span class="quant">0 ea</span><br>
							<b class="info-title w-40 mr-3 mb-1">월 광고료</b><span class="adPriceMonth">-</span><br>
		...
		<div class="unicon-palette">
			...
			<div class="color-part">
				...
				<span class="unicon"><i class="unicon-circle-pink-fill"></i></span>
				<span class="unicon"><i class="unicon-circle-gray-fill"></i></span>
		...
		<div class="filter-window">
			...
			<div class="">
				<select class="w-100 form-control input-underline" name="targetFacilA" id="targetFacilA">
				</select>
			</div>
			<div class="" style="height:38px;">
				<input type="hidden" id="select-dvsn2"/>
				<select class="w-100 form-control input-underline" name="targetFacilB" id="targetFacilB">
				</select>
			</div>
			<div class="custom-control custom-radio ml-1 mt-3 mb-2">
			...
			<div class="custom-control custom-radio ml-1 mt-2 mb-2">
					<input type="radio" name="mediaFilter"
...
<!-- 						<label for="ExcelDown">양식 다운로드</label> -->
							<a id="ExcelDown" name="ExcelDown" class="btn btn-sm btn-radius-all btn-blue float-right"  title="양식 다운로드" href="" >양식 다운로드</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- 		파일업로드 팝업 종료 -->
	...
	<script src="/resources/main/js/campaign/create_new.js"></script>
